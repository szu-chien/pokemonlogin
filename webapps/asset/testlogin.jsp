...
<html>
  ...
  <body>
    ...
    <div class="form-group">
        <label for="account" class="control-label" id="result">account</label>
        <input type="text" id="account" placeholder="account..."class="form-control" name="account" required=""></div>
  ...
  <div class="form-group">
         ...
         <input type="text" name="name" placeholder="name..." class="form-email form-control"  required="">
       </div>
